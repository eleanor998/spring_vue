...
public class RandomValue {
    ...
    public static boolean testPhone(String str) {
        Pattern pat = Pattern.compile("^[1][357698][0-9]{9}$");
     ...
     * @return
     */
    public static <T> T randomSelect(T... option) {
        if (option != null) {
            int randomInt = getRandomInt(0, option.length);
            return option[randomInt == 0 ? randomInt : option.length % randomInt];
        }
        return null;
    }
    ...
    public static int getRandomInt(int min, int max) {
        return new Random(min).nextInt(max);
    }
